...
export function ButtonLink({ href, children, variant = "primary" }: { href: string; children: React.ReactNode; variant?: "primary" | "secondary" | "light" }) {
  ...
  return (
    <Link href={href} className={`group inline-flex min-h-12 items-center justify-center gap-3 px-5 text-[0.72rem] font-bold uppercase tracking-[0.16em] transition-colors ${styles[variant]}`}>
