...
import { Activity, ArrowRight, Boxes, CalendarClock, Handshake, ListChecks, PackageCheck } from "lucide-react";
...
export function WorkflowOverviewStrip({ overview }: { overview: WorkflowOverview }) {
  const hasSignals = Boolean(overview.planning || overview.tendering || overview.pickup || overview.visibility || overview.delivery || overview.finance);
  ...
  return <section className="ops-content-wide pt-5">
    <div className="overflow-hidden rounded-[15px] border border-[#ded8d2] bg-[#fffdfa] shadow-[0_8px_28px_rgba(54,43,34,.04)]">
      ...
      <div className="grid divide-y divide-[#ece6e0] lg:grid-cols-6 lg:divide-x lg:divide-y-0">
