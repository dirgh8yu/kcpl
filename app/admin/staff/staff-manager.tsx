...
export function StaffManager({ initialProfiles }: { initialProfiles: KcplStaffProfile[] }) {
  ...
  return <main className="min-h-screen bg-[#f4f1e9] text-[#10263f]">
    ...
    <style>{`.staff-input{width:100%;border:1px solid rgba(0,0,0,.1);border-radius:12px;background:#faf9f5;padding:11px 12px;font-size:14px;outline:none}.staff-input:focus{border-color:#b78a3e}`}</style>
  </main>;
}
