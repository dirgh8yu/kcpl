...
export const workflowWorkspaces: WorkflowWorkspace[] = [
  ...
  { id: "site-gallery", href: "/admin/gallery", label: "Website Gallery", group: "Organisation", hint: "Upload and publish photos on the public website", keywords: ["gallery", "website", "photo", "image", "publish"], permission: "management", icon: "Folder", prefixes: ["/admin/gallery"] },
