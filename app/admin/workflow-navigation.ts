...
export const workflowWorkspaces: WorkflowWorkspace[] = [
  ...
  { id: "enquiries", href: "/admin/enquiries", label: "Enquiries", group: "Plan & Sell", hint: "Incoming freight requests and quote pipeline", keywords: ["enquiry", "quote", "request", "lead"], permission: "all", prefixes: ["/admin/enquiries"] },
