      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_340px]">
        <div>
          <label className="block rounded-[var(--app-radius)] border border-dashed border-[#d8cec6] bg-[#fbf8f5] p-6 text-center transition hover:border-[#caa797] hover:bg-[#fffaf7]">
            ...
            <span className="mx-auto grid h-10 w-10 place-items-center rounded-[var(--app-radius)] bg-white text-[#bd654f] shadow-[0_5px_18px_rgba(80,55,40,.06)]"><Landmark size={17}/></span>
            <strong className="mt-3 block text-[12px] text-[var(--admin-ink)]">{file ? file.name : "Choose Stage 3A receivables CSV"}</strong>
        ...
        <div className="rounded-[var(--app-radius)] border border-[var(--admin-line)] bg-[var(--admin-surface-muted)] p-4">
          <p className="text-[length:var(--app-label-size)] font-bold uppercase tracking-[.08em] text-[#9a8e85]">Stage 3A rules</p>
