...
function PreviewPanel({ preview, confirmed, busy, onConfirmed, onImport }: { preview: PayablesImportPreview; confirmed: boolean; busy: "preview" | "import" | ""; onConfirmed: (value: boolean) => void; onImport: () => void }) {
  return <OpsSurface density="compact" title="Reconcile every supplier payable before writing" description={`${preview.total} rows detected in ${preview.filename}. Only rows marked Ready will be created.`} flush>
