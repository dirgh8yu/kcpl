...
export function EdiWorkspace({ initialRows, initialSummary, initialConfigured, initialEligibleTenders, canQueue204 }: {
  ...
  return <div className="ops-content-wide py-5">
    ...
    {canQueue204 ? <section className="mt-5 rounded-[15px] border border-[#e2dbd5] bg-white p-4">
      ...
      <p className="mt-2 text-[9px] leading-4 text-[#81776f]">Sent manual tenders can be converted to EDI 204 before any email dispatch. The tender reference and commercial snapshot remain the same, so the carrier 990 response returns to the existing procurement record.</p>
