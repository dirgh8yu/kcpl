...
export default async function Customer360Page({ params }: { params: Promise<{ id: string }> }) {
  ...
  >
    ...
    <section className="ops-content-wide pb-12 pt-0">
      <div className="mb-3 border-b border-[#e2e2e2] pb-3"><p className="ops-eyebrow">Account tools</p><h2 className="mt-1 text-[15px] font-semibold tracking-[-.01em] text-[#141414]">Advanced customer controls</h2><p className="mt-1 max-w-2xl text-[11px] leading-[17px] text-[#737373]">Detailed profile editing, operational history, rate cards, document storage and quote matching stay available without crowding the everyday account view.</p></div>
