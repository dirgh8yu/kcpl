...
export default function PrivacyPage() {
  return <PageShell eyebrow="Privacy" title="A clear approach to website information." intro="This policy explains what the KCPL website processes when you browse the site or submit a freight enquiry.">
    <section className="privacy-section bg-offwhite"><Container><div className="privacy-layout"><aside><p className="eyebrow text-rhododendron">Last updated</p><strong>20 August 2026</strong><Link href={`mailto:${company.email}`}>Questions about privacy</Link></aside><article>
      ...
      <section><h2>Internal staff sign-in</h2><p>When an authorised KCPL staff member uses Sign in with ChatGPT to access the operations dashboard, the website receives the authenticated account email and, where available, profile name on the server. KCPL uses that identity to check dashboard access and to identify the staff member who adds an internal operational note. The internal dashboard is excluded from KCPL&apos;s optional public website analytics.</p></section>
