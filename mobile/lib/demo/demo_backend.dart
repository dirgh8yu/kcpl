...
class DemoApi extends KcplApi {
  ...
  @override
  Future<SessionView> session() => _later(SessionView(
  ...
  List<Invoice> get _invoices => [
        ...
        Invoice(
          ...
          shipmentReference: 'KCPL-S-24077',
          lines: const [
            InvoiceLine(id: '1', description: 'Sea freight Haldia to Biratnagar', quantity: 1, unitPrice: 1840, total: 1840),
          ],
        ),
        Invoice(
