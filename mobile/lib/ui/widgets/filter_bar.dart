          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: _query.text.isEmpty
                  ? null
                  : IconButton(tooltip: widget.clearLabel, onPressed: _clear, icon: const Icon(Icons.close, size: 18)),
              isDense: true,
              ...
              for (final entry in widget.options.entries)
                Padding(
                  ...
                  child: ChoiceChip(
                    ...
                    label: Text(
                      entry.value,
                      style: TextStyle(color: entry.key == widget.selected ? context.palette.paper : context.palette.ink),
                    ),
