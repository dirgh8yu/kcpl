    ...
    return [
      ...
      Bento(
        rows: [
          ...
          [
            BentoTile(label: 'Customs blocks', value: totals.customsBlockers, icon: KIcons.customs, onTap: () => onNavigate(OpsTab.jobs)),
            BentoTile(label: 'Exceptions', value: totals.exceptions, icon: KIcons.warning, attention: true),
            BentoTile(label: 'Deliveries today', value: totals.deliveriesToday, icon: KIcons.truck),
          ],
        ],
      ),
      if (mine.isNotEmpty) ...[
