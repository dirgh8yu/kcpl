...
const appStrings = [
  ...
  // Proof of delivery
  ["podTitle", "Proof of delivery", "डेलिभरीको प्रमाण"],
  ["podReceivedBy", "Received by {name}", "{name} ले बुझ्नुभयो"],
  ["podReceivedByAs", "Received by {name}, {relation}", "{name} ({relation}) ले बुझ्नुभयो"],
  ["podDelivered", "Delivered {date}", "{date} मा डेलिभर भयो"],
  ["podChecked", "Checked by KCPL", "KCPL ले जाँचेको"],
  ["podSignature", "Signature", "हस्ताक्षर"],
  ["podPhoto", "Delivery photo {number}", "डेलिभरी फोटो {number}", {"number": "int"}],
  ["podDocument", "Delivery document", "डेलिभरी कागजात"],
  ["podNothingShared", "KCPL checked this delivery. No signature or photos were shared.", "KCPL ले यो डेलिभरी जाँच्यो। हस्ताक्षर वा फोटो साझा गरिएको छैन।"],
  ["podLoadFailed", "Couldn't load", "लोड भएन"],
  // Pickup with a booking
  ["pickupTitle", "Pickup", "पिकअप"],
  ["pickupAsk", "KCPL picks up the cargo", "KCPL ले माल उठाओस्"],
  ["pickupAskBody", "Say when and where. The pickup desk confirms the time with you.", "कहिले र कहाँ भन्नुहोस्। पिकअप डेस्कले तपाईंसँग समय पक्का गर्छ।"],
  ["pickupDate", "Date", "मिति"],
  ["pickupWindow", "Time", "समय"],
  ["pickupMorning", "Morning", "बिहान"],
  ["pickupAfternoon", "Afternoon", "दिउँसो"],
  ["pickupAnyTime", "Any time", "जुनसुकै बेला"],
  ["pickupAddress", "Pickup address", "पिकअप ठेगाना"],
  ["pickupContactName", "Contact person (optional)", "सम्पर्क व्यक्ति (ऐच्छिक)"],
  ["pickupContactPhone", "Contact phone (optional)", "सम्पर्क फोन (ऐच्छिक)"],
  ["pickupNeedAddress", "Enter where the cargo is to be picked up.", "माल कहाँबाट उठाउने हो लेख्नुहोस्।"],
  ["pickupFootnote", "A request: the pickup desk schedules it once your booking is confirmed.", "यो अनुरोध हो: बुकिङ पक्का भएपछि पिकअप डेस्कले समय तोक्छ।"],
  ["pickupAsked", "Pickup asked for {date}", "{date} मा पिकअप माग गरियो"],
  // Statement of account
  ["statementTitle", "Account statement", "खाता विवरण"],
  ["statementSubtitle", "PDF · owed, overdue and payments, last 12 months", "PDF · बाँकी, म्याद नाघेको र भुक्तानी, पछिल्ला १२ महिना"],
  ["statementFailed", "The statement couldn't be downloaded.", "विवरण डाउनलोड हुन सकेन।"],
  // SMS and WhatsApp
  ["textTitle", "SMS and WhatsApp", "SMS र WhatsApp"],
  ["textOff", "Off", "बन्द"],
  ["textSms", "SMS", "SMS"],
  ["textWhatsapp", "WhatsApp", "WhatsApp"],
  ["textPhone", "Mobile number", "मोबाइल नम्बर"],
  ["textPhoneHintSms", "98XXXXXXXX", "98XXXXXXXX"],
  ["textPhoneHintWhatsapp", "+977 98XXXXXXXX", "+977 98XXXXXXXX"],
  ["textConsent", "I agree to receive KCPL shipment and invoice messages on this number.", "यो नम्बरमा KCPL को ढुवानी र बिलसम्बन्धी सन्देश पाउन म सहमत छु।"],
  ["textNeedConsent", "Tick the box to agree to these messages.", "यी सन्देश पाउन सहमति जनाउन बाकसमा टिक लगाउनुहोस्।"],
  ["textFootnote", "The same updates as your notifications, shortened to one message, for when the app isn't to hand. Turn off any time.", "तपाईंका सूचनाकै अपडेट, छोटो सन्देशमा, एप नहुँदा पनि। जुनसुकै बेला बन्द गर्न सकिन्छ।"],
  ["textSave", "Save", "सुरक्षित गर्नुहोस्"],
  ["textSaved", "Saved", "सुरक्षित भयो"],
  // "KCPL needs a document from you"
  ["docreqNeeded", "KCPL needs your {document}", "KCPL लाई तपाईंको {document} चाहियो"],
  ["docreqResend", "KCPL needs your {document} again", "KCPL लाई तपाईंको {document} फेरि चाहियो"],
  ["docreqBody", "Scan it now: it goes straight to the team handling {reference}.", "अहिले स्क्यान गर्नुहोस्: यो सिधै {reference} हेर्ने टोलीमा पुग्छ।"],
  ["docreqScan", "Scan {document}", "{document} स्क्यान गर्नुहोस्"],
  ["docreqOther", "Choose a photo or file instead", "बरु फोटो वा फाइल छान्नुहोस्"],
